...
#design_proposal(
  ...
  scope: [
    ...
    - instance binding, source-content identity, validation, and lifetime
  ...
  open_questions: [
    ...
    - Whether the client recomputes content identity or relies on a verified
      artifact mapping under the accepted resource budget
...
#behavior_spec(
  ...
  preconditions: [
    ...
    - the activation artifact, DOM host, and handoff record have matching
      instance and source-content identities
  ],
  postconditions: [
...
#behavior_spec(
  ...
  preconditions: [
    - an expected instance ID, source-content ID, artifact identity, or handoff
      record is missing, stale, duplicated, or mismatched
  ],
  postconditions: [
