...
`implementation.ts` is the package-local facade. Keep model definitions, budget accounting, canonical parsing, semantic parsing, and source closure in focused internal modules.
