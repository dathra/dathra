...
This file continues the split `ProjectionManifestCore` mapping introduced in [D51](51-graph-table-payload.md); [D53](53-projection-and-boot.md) completes the mapping and boot contracts.
